...
ActiveRecord::Schema.define(version: 2018_11_03_173701) do
  ...
  create_table "administrateurs", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.index ["phonenumber"], name: "index_administrateurs_on_phonenumber", unique: true
    t.index ["reset_password_token"], name: "index_administrateurs_on_reset_password_token", unique: true
    t.index ["username"], name: "index_administrateurs_on_username", unique: true
  end
