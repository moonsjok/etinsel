class IdentitiesController < ApplicationController
  ...
  def edit
          puts @user.id
           ...
           if @identity.typeannonceur.nil?
                 @typeannonceur_value = @identity.typeannonceur
                 @typeannonceur_text = @identity.typeannonceur
           else
             @typeannonceur_value =' '
             @typeannonceur_text ='---------------'
           end
  ...
  def create
    ...
    respond_to do |format|
      if @identity.save
        format.html { redirect_to "/monprofil/indentiter", notice: 'Identity was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @identity.update(identity_params)
        format.html { redirect_to "/monprofil/", notice: 'Identity was successfully updated.' }
  ...
  private
    ...
    def identity_params
      params.require(:identity).permit(:typeannonceur, :name, :country, :city, :adress, :zip, :about, :user_id)
    end
end
